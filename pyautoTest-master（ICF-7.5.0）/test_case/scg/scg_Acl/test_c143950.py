...
# 根据源interface/zone查找rule

def test_c143950(browser):
	try:
		...
		# 高级搜索
		find_ipv4acl_lzy(browser, source_zone_interface=interface_name_3)
		sleep(5)
		# 获取信息
		browser.switch_to.default_content()
		browser.switch_to.frame("content")
		browser.switch_to.frame("iFrame1")
		info1 = browser.find_element_by_xpath('//*[@id="fromezone0"]').text
		# print(info1)
		...
		try:
			assert interface_name_3 in info1
