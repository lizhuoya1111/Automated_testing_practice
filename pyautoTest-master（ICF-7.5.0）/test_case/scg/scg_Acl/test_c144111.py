...
test_id = "144111"
# 描述中异常字符检查
# 在ipv4 acl group和ipv6 acl group的描述中输入$ #这两个字符
# 无ipv6


def test_c144111(browser):

	try:
		login_web(browser, url=dev4)
		time.sleep(1)

		add_acl_group_before_save(browser, name="acl_grp_111", enable='yes', sour='Z:any', dest='Z:any', desc='$ #')
