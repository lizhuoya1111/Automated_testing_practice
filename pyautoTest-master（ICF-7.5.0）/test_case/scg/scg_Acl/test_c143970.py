...
# 输入13.1.1.3掩码为255.255.255.0，目的接口选择ge0/2.2，service为all，
# 动作为deny，其他为默认配置
# 来自source address的地址不能穿过DUT

def test_c143970(browser):
	try:
		...
		add_ipv4acl_lzy(browser, aclgroup_name='lzy', source_zone_interface=interface_name_3,
						...
						source_address_object='no', dest_zone_interface=interface_name_2+'.1', drop='yes')
		sleep(2)
