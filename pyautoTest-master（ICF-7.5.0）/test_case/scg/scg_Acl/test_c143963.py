...
def test_c143963(browser):
	...
	try:
		...
		add_vlan_inte_add(browser, interface_name=interface_name_4 + ".1", ipadd="20.1.1.1", mask="24")
		add_vlan_inte_add(browser, interface_name=interface_name_5 + ".1", ipadd="21.1.1.1", mask="24")
		...
		add_obj_address_wxw(browser, name='pc2', desc='zhe是yi个描述1', subnetip='20.1.1.2', subnetmask='24')

		del_all_acl_group_noadd_wxw(browser)
		add_acl_group_wxw(browser, name='acl_group')
		add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group', source_zone_interface=interface_name_4 + ".1",
								  source_address_object='yes', s_address_object='A:pc2',
