...
# 2.在acl中设置源interface为GE0/1，source address选择custom，
# 输入192.168.7.22掩码为255.255.255.255，目的地址选择ge0/2.2，
# service为all，其他为默认配置
# 来自这个custom的source address的地址可以穿过DUT访问vlan，别的地址不行

def test_c143968(browser):
	try:
		login_web(browser, url=dev3)
		# 83 #2 添加ip192.168.7.22
		shell_83 = Shell_SSH()
		shell_83.connect(hostip=dev3)
		shell_83.execute("en")
		shell_83.execute("conf t")
		shell_83.execute("interface gigabitethernet "+interface_name_2)
		shell_83.execute("ip address 192.168.7.22 255.255.255.0")
		shell_83.close()
		...
		shell_81.execute("interface gigabitethernet "+interface_name_3)
		shell_81.execute("ip address 192.168.7.23 255.255.255.0")
		shell_81.close()
		...
		shell_82.execute("en")
		shell_82.execute("conf t")
		shell_82.execute("ip route 192.168.7.0/24 gateway 12.1.1.1")
		shell_82.close()
		...
		shell_83.execute("en")
		shell_83.execute("conf t")
		shell_83.execute("ip route 12.1.1.0/24 gateway 192.168.7.23")
		shell_83.close()
		...
		add_ipv4acl_lzy(browser, aclgroup_name='lzy', source_zone_interface=interface_name_3,
						source_custom='yes', fromip='192.168.7.22', fromnetmask='255.255.255.255',
		...
		shell_82.execute("en")
		shell_82.execute("conf t")
		shell_82.execute("no ip route 192.168.7.0/24 gateway 12.1.1.1")
		shell_82.close()
		...
		shell_83.execute("en")
		shell_83.execute("conf t")
		shell_83.execute("no ip route 12.1.1.0/24 gateway 192.168.7.23")
		shell_83.close()
		...
		shell_83.execute("conf t")
		shell_83.execute("interface gigabitethernet "+interface_name_2)
		shell_83.execute("no ip address 192.168.7.22")
		shell_83.close()
		...
		shell_81.execute("conf t")
		shell_81.execute("interface gigabitethernet "+interface_name_3)
		shell_81.execute("no ip address 192.168.7.23")
		shell_81.close()
