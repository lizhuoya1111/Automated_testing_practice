...
def test_c143964(browser):
	try:
		...
		add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group', source_zone_interface=interface_name_4 + ".2",
								  source_custom='yes', fromip='20.1.1.2', fromnetmask='255.255.255.0',source_address_object='no',
		...
		try:
			assert "Server: Apache" in pc2topc3_http_info
