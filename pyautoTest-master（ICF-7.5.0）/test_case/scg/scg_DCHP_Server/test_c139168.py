...
def test_c139168(browser):
	try:
		...
		dhcp_server_add_jyl(browser, interface=interface_name_5, dhcp_type="dhcp_server", dhcp_gw="192.165.12.1",
								dhcp_sm="24")
		time.sleep(1)
		dhcp_server_edit_or_delete(browser, fuction="edit", dhcp_type="rely",
										   dhcp_rely_server1="117.117.117.117")
		time.sleep(1)
		dhcp_server_edit_or_delete(browser, fuction="edit", dhcp_type="none")
		time.sleep(2)
