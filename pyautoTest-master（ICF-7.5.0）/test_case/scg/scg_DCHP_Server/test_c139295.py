...
def test_c139295(browser):
	try:
		...
		# 输入dhcp WINS服务器1
		browser.find_element_by_xpath('//*[@id="winsserver1"]').send_keys("115.115.115.115")
		# 点击高级
		browser.find_element_by_xpath('//*[@id="is_dhcp_adv"]').click()
		# 输入dhcp WINS服务器2
		browser.find_element_by_xpath('//*[@id="winsserver2"]').send_keys("115.115.115.115")
		# 点击保存
		...
		try:
			assert webinfo == "不能给不同的WINS服务器设置相同的值"
