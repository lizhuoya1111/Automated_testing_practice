...
def test_c139315(browser):
	try:
		...
		# 选interface下拉框内容
		s1.select_by_visible_text(interface_name_5)
		# 点击增加
		...
		# 输入dhcp网关
		browser.find_element_by_xpath('//*[@id="gateway"]').send_keys("192.165.12.1")
		# 输入dhcp子网掩码
		browser.find_element_by_xpath('//*[@id="netmask"]').send_keys("24")
		# 输入dhcp ip地址范围1
		browser.find_element_by_xpath('//*[@id="ipfrom1"]').send_keys("192.165.12.3")
		browser.find_element_by_xpath('//*[@id="ipto1"]').send_keys("192.165.12.10")
		# 点击高级
		browser.find_element_by_xpath('//*[@id="is_dhcp_adv"]').click()
		# 输入静态ip地址
		browser.find_element_by_xpath('//*[@id="ip0"]').send_keys("192.165.12.255")
		# 输入静态mac地址
		browser.find_element_by_xpath('//*[@id="mac0"]').send_keys("00:16:31:E3:33:79")
		# 点击保存
