...
def test_c139304(browser):
	try:
		...
		# 输入dhcp ip地址范围1
		browser.find_element_by_xpath('//*[@id="ipfrom1"]').send_keys("131.1.1.20")
		browser.find_element_by_xpath('//*[@id="ipto1"]').send_keys("131.1.1.4")
		# 点击保存
