...
def test_c139293(browser):
	try:
		...
		# 输入dhcp DNS服务器1
		browser.find_element_by_xpath('//*[@id="dnsserver1"]').send_keys("114.114.114.114")
		# 点击高级
		browser.find_element_by_xpath('//*[@id="is_dhcp_adv"]').click()
		# 输入dhcp DNS服务器2
		browser.find_element_by_xpath('//*[@id="dnsserver2"]').send_keys("114.114.114.114")
		# 点击保存
		...
		try:
			assert webinfo == "不能给不同的DNS服务器设置相同的值"
