...
# 因dhcp动态地址池无法配置3个范围的地址，所以此运例暂时运行不成功，之后修改bug之后可以运行成功。
test_id = 139193
def test_c139193(browser):
	try:
		...
		dhcp_server_add_jyl(browser, interface=interface_name_3, dhcp_type="dhcp_server", dhcp_gw="131.1.1.254",
							dhcp_sm="24",
							ip_range1_1="131.1.1.4", ip_range1_2="131.1.1.10", ip_range2_1="131.1.1.11",
							ip_range2_2="131.1.1.20", ip_range3_1="131.1.1.21", ip_range3_2="131.1.1.30")
