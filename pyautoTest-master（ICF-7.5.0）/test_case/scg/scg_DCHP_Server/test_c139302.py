...
def test_c139302(browser):
	try:
		...
		# 输入静态ip地址
		browser.find_element_by_xpath('//*[@id="ip0"]').send_keys("13.1.1.4")
		# 输入静态mac地址
		browser.find_element_by_xpath('//*[@id="mac0"]').send_keys("e8:j7:48:57:19:c3")
		# 点击保存
		...
		try:
			assert webinfo == "物理地址(MAC)格式输入错误，请重新输入。"
