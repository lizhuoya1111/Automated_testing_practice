...
def test_c139305(browser):
	try:
		...
		# 输入dhcp ip地址范围1
		browser.find_element_by_xpath('//*[@id="ipfrom1"]').send_keys("14.1.2.4")
		browser.find_element_by_xpath('//*[@id="ipto1"]').send_keys("14.1.2.20")
		# 点击保存
		...
		try:
			assert webinfo == "动态IP范围必须和网关在同一个子网"
