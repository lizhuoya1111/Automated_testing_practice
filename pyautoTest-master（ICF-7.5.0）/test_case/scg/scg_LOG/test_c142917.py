...
def test_c142917(browser):
    try:
        ...
        query_security_or_traffic_log_lzy(browser, log_type=流量日志, ambiguous_search="",
                                          ...
                                          to_port="",
                                          protocol="", exclude_protocol="", start_date=date1, start_time="",
        ...
        query_security_or_traffic_log_lzy(browser, log_type=流量日志, ambiguous_search="",
        									  ...
        									  protocol="", exclude_protocol="", start_date=date2, start_time="", end_date=date1, end_time="")
