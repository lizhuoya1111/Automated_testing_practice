...
test_id = 142923
# 在security日志中，根据exclude ip查询日志，查询不在该源ip范围内的日志
def test_c142923(browser):
	try:
		# 登录admin
		...
		query_security_or_traffic_log_lzy(browser, log_type=安全日志, ambiguous_search="",
										  from_ip="12.1.1.3", exclude_from_ip="", to_ip="", exclude_to_ip="",
										  from_port="",
										  to_port="",
		...
		# 查询日志
		query_security_or_traffic_log_lzy(browser, log_type=安全日志, ambiguous_search="",
										  from_ip="", exclude_from_ip="12.1.1.3", to_ip="", exclude_to_ip="",
										  from_port="",
										  to_port="",
										  protocol="", exclude_protocol="", start_date="", start_time="", end_date="",
										  end_time="")
		...
		try:
			assert '12.1.1.3' in info1 and '0' in num1
