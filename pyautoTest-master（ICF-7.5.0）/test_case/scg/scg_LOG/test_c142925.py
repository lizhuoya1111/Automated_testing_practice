...
test_id = 142925
# 在traffic日志中，设置include条件为目的ip，查询有该目的ip的所有日志
#
def test_c142925(browser):
	try:
		# 登录admin
		...
		query_security_or_traffic_log_lzy(browser, log_type=流量日志, ambiguous_search="",
										  from_ip="", exclude_from_ip="", to_ip="13.1.1.3", exclude_to_ip="", from_port="",
										  to_port="",
		...
		# 获取信息
		sleep(0.5)
		info2 = browser.find_element_by_xpath('//*[@id="dst_portarea0"]').text
		# print(info2)
