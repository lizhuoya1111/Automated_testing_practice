...
def test_c142908(browser):
    try:
        ...
        login_web(browser, url=dev1)
        # 根据功能模块查询
        advanced_query_security_or_traffic_log_lzy(browser, log_type=安全日志, advanced="yes/no", ambiguous_search="",
        ...
        try:
            assert 'neighmacipmacbind' in info1
