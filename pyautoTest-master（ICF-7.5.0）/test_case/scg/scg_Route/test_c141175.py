...
test_id = "141175"
# Route maitance group gateway 功能 2
# 填入gateway ip
# 成功添加到group里，可被路由成功引用


def test_141175(browser):
	...
	try:
		...
		for n in range(1, 5):
			...
			add_multi_gateway_group_wxw(browser, name='mgg_175_'+str(n), group="1(GROUP_1)", modify='no', alias='',
