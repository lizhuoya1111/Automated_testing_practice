...
test_id = "141176"
# Route maitance group gateway 功能 3
# 填入Bandwidth（upband downband）
# 成功添加到group里，可被路由成功引用


def test_141176(browser):
	...
	try:
		...
		for n in range(1, 5):
			...
			add_multi_gateway_group_wxw(browser, name='mgg_176_'+str(n), group="1(GROUP_1)", modify='no', alias='',
		...
		try:
			assert "100000:100000" in loginfo1
