...
def test_c140977(browser):
	...
	try:
		...
		for n in range(1, 5):
			...
			add_multi_gateway_group_wxw(browser, name='mgg_167_'+str(n), group="1(GROUP_1)", modify='no', alias='',
									    device=interface_name_3, gateway='24.1.1.1'+str(n), ping_server='24.1.1.4', ping='yes',
		...
		enable = is_static_route_enable_wxw(browser, destination='20.1.1.0/255.255.255.0')
		# print(enable)
