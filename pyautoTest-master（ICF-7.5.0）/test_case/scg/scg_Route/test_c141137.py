...
test_id = "141137"
# 验证list里的编辑按钮，编辑一条多网关策略路由
# 修改后的参数都能立即生效


def test_c141137(browser):
    ...
    try:
        ...
        edit_policy_route_multi_by_index_number_lzy(browser, index_number='1',
                                                in_device='全部', src_ip='12.1.1.0', src_mask='24', dst_ip='34.1.1.0', dst_mask='24',
                                                service='yes', serv='any',
                                                service_grp='no', serv_grp='H323', gw_group='1(GROUP_1)', grp_mem=["主用", "备份1"],
                                                enable='yes', desc='maioshu', save='yes', cancel='no')
