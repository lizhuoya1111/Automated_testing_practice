...
def test_c140155(browser):
	...
	try:
		...
		if oem_name == "ICF" or oem_name != "SCG":
			...
			add_ipsec_remote_gateway_gm(browser, name='ipsec_jia_1', desc='miaoshu', status='enable', out_interface=interface_name_6,
