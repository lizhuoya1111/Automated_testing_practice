...
def test_c140270(browser):
	...
	try:
		...
		result = get_ipsec_station_byname(browser, ipsec_name="ipsec_jia_1")
		# print(result)
		loginfo1 = get_log_info(browser, 管理日志)
		del_ipsec_remote_gateway_wxw(browser, name='ipsec_jia_1')
		try:
			assert "ipsec_jia_1" in result[1] and "12.1.1.1" in result[2] and "Stop"in result[5]
