...
test_id = "140170"
# 网关接入基本配置1
# 设置正确格式的IKE Name（例：tt1）和150字符以内的描述
# 可以设置成功,有日志记录


def test_c140170(browser):
	...
	try:
		...
		if oem_name == "ICF" or oem_name != "SCG":
			...
			add_ipsec_remote_gateway_gm(browser, name='ttl', desc='miaoshu', status='enable', out_interface=interface_name_1,
