...
def test_c140152(browser):

	try:
		login_web(browser, url=dev1)
		# add_ipsec_remote_gateway_wxw(browser, name='tt123', desc=' ', status='enable',
		...
		if oem_name == "ICF" or oem_name != "SCG":
			...
			add_ipsec_remote_gateway_gm(browser, name='tt123', desc='miaoshu', status='enable', out_interface=interface_name_2,
		...
		del_ipsec_remote_gateway_wxw(browser, name='tt123')
