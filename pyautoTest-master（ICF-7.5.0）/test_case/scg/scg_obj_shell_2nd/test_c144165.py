...
test_id = "144165"
# 选择多条serv grp,再unselected


def test_c144165(browser):
    try:
        ...
        # 取消勾选
        cancel_select_obj_serv_group_by_name(browser, name='lzy2')
        cancel_select_obj_serv_group_by_name(browser, name='lzy3')
        # 判断服务组是否被勾选
        ...
        try:
            assert '未被勾选' in judge1 and '未被勾选' in judge2
