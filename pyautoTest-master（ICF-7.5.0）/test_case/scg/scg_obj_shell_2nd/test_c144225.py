...
def test_c144225(browser):
	...
	try:
		...
		add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group', source_zone_interface="Z:any",
								  source_address_object='yes', s_address_object='R:obj_add_range_353',
								  dest_address_object='yes', d_address_object='R:obj_add_range_353',
		...
		info1 = del_obj_range_wxw(browser, name='obj_add_range_353', alert_info="yes")
		# print(info1)

		try:
			assert "对象正在使用" in info1
		...
		del_obj_range_wxw(browser, name='obj_add_range_353', alert_info="yes")
		# ssh_pc2.execute('exit')
		# ssh_pc2_4 = Shell_SSH()
