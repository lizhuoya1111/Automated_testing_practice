...
def test_c144220(browser):
	...
	try:
		...
		info1 = del_obj_serv_grp_wxw(browser, name='obj_serv_ftp', alert_info="yes")
		# print(info1)

		try:
			assert "230 Login successful." not in pc2topc3_ftp_info and \
					"对象正在使用" in info1
		...
		del_obj_serv_grp_wxw(browser, name='obj_serv_ftp')
