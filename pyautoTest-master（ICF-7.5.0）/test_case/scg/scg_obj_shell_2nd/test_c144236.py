...
def test_c144236(browser):
	try:
		...
		# 创建DNAT规则
		add_obj_address_range_wxw(browser, name='obj_add_range_src', desc='源地址范围', fromip='20.1.1.2',
		                          toip='20.1.1.2')

		add_obj_address_range_wxw(browser, name='obj_add_range_dest', desc='目的地址范围', fromip='20.1.1.1',
		                          toip='20.1.1.1')

		add_dnat(browser, name='dnat_235', src_inter_zone=interface_name_4, src_ipadd_switch="预定义",
		         srcaddress_predefine="R:obj_add_range_src",
		         srcip_custom="", srcmask_custom="", des_ipadd_switch="预定义", desaddress_predefine="R:obj_add_range_dest",
		...
		# print("------------------------------------------------------------------")
		ssh_pc2.close()
		del_obj_range_info1 = del_obj_range_wxw(browser, name='obj_add_range_src', alert_info="yes")
		del_obj_range_info2 = del_obj_range_wxw(browser, name='obj_add_range_dest', alert_info="yes")
		# print(del_obj_range_info1, del_obj_range_info2)

		try:
			assert "230 Login successful." in pc2topc3_ftp_info and \
				"对象正在使用" in del_obj_range_info1 and \
				"对象正在使用" in del_obj_range_info2
		...
		del_obj_range_wxw(browser, name='obj_add_range_src')
		del_obj_range_wxw(browser, name='obj_add_range_dest')
