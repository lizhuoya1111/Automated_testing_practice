...
def test_c144136(browser):
	...
	try:
		...
		edit_obj_group_use_addr_obj_wxw(browser, name='obj_grp_359', addr_obj='A:obj_add_351')
		...
		try:
			assert "配置地址组对象成功，修改内部对象 [obj_grp_359]，具体属性 : 所选地址为 [obj_add_359,obj_add_351,]" in loginfo
