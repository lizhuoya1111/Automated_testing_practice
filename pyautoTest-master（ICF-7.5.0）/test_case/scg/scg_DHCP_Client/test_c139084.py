...
def test_139084(browser):
	try:
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_update_dhcp_jyl(browser, vlan_interface=interface_name_2+".22", update_system_dns="open")
		time.sleep(1)
		...
		time.sleep(3)
		bridge_interface_update_dhcp_jyl(browser, bridge="br_1", update_system_dns="open")
		time.sleep(1)
