...
def test_c139098(browser):
	try:
		...
		time.sleep(1)
		dhcp_client_obtain_ip_dhcp_static(browser, interface=interface_name_2, dhcp_static="release")
		time.sleep(1)
		loginfo1 = get_log(browser, 管理日志)
		time.sleep(1)
		dhcp_client_obtain_ip_dhcp_static(browser, interface=interface_name_2, dhcp_static="renew")
		loginfo2 = get_log(browser, 管理日志)
		time.sleep(3)
		# print("nsdfoisdhfiophsdpifhsdpifhpd")
		dhcp_client_obtain_ip_dhcp_static(browser, interface=interface_name_2, dhcp_static="refesh")
		loginfo3 = get_log(browser, 管理日志)
		time.sleep(1)
		dhcp_client_obtain_ip_dhcp_static(browser, interface=interface_name_2, dhcp_static="new_obtain")
