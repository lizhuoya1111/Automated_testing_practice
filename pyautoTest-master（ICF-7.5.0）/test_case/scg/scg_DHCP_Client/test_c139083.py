...
def test_c139083(browser):
	try:
		...
		time.sleep(3)
		bridge_interface_update_dhcp_jyl(browser, bridge="br_1", update_default_gateway="open")
		time.sleep(1)
		...
		try:
			assert "dhcp服务器增加网关" in loginfo1
			assert "dhcp服务器增加网关" in loginfo2
