...
def test_c139085(browser):
	try:
		...
		time.sleep(1)
		physical_interface_update_dhcp_jyl(browser, physical_interface=interface_name_2, update_system_dns="open", update_default_gateway="open")
		time.sleep(1)
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_update_dhcp_jyl(browser, vlan_interface=interface_name_2+".22", update_system_dns="open", update_default_gateway="open")
		time.sleep(1)
		...
		time.sleep(3)
		bridge_interface_update_dhcp_jyl(browser, bridge="br_1", update_system_dns="open", update_default_gateway="open")
		time.sleep(1)
		...
		try:
			assert "dhcp服务器" in loginfo1
			assert "dhcp服务器" in loginfo2
			assert "DHCP Client成功" in loginfo3
