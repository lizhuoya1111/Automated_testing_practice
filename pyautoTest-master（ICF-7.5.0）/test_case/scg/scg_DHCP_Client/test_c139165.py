...
def test_c139165(browser):
	try:
		...
		vlan_add_jyl(browser, physicl_interface=interface_name_2, vlan_id="4094", work_mode="route")
		a = Shell_SSH()
		a.connect(dev3)
		a.execute("en")
		a.execute("conf t")
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_update_dhcp_jyl(browser, vlan_interface=interface_name_2+".4094", update_system_dns="open")
		time.sleep(1)
		loginfo1 = get_log(browser, 管理日志)
		# print(loginfo1)
		time.sleep(1)
		vlan_interface_obtain_ip_dhcp_status_jyl(browser, vlan_interface=interface_name_2+".4094",  dhcp_status2="stop",)
		time.sleep(1)
