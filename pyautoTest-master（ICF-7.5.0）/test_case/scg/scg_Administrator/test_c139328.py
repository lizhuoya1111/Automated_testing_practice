...
def configuer(browser):
	...
	add_admin(browser, admin_name="zxcvbnmasdfghjklpoiuytrewqzxcvb", auth_database="local", temp="aaa", https="yes",
	              telent="no", ssh="yes", console="yes", status="enable", interface=interface_name_3,
			  password="admin@139", confirm_password="admin@139", online_num="3", ip1="0.0.0.0/0")
