...
def test_139338(browser):
	try:
		...
		# time.sleep(2)
		# for x in range(1, 11):
		# 	add_admin(browser, admin_name="bob"+str(x), auth_database="local", temp="aaa"+str(x), https="yes", telent="no",
		...
		# # print(web_admin1)
		#
		# language_switch(browser, language="Traditional Chinese")
		#
		# # # 定位到左侧frame
