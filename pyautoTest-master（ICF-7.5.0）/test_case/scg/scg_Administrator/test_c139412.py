...
def test_c139412(browser):
	try:
		# 登录函数
		login_web(browser, url=dev1)
		add_admin_profile(browser, profile_name='aaa1', desc='描述1', cfg="读写", report="读写")
		add_admin_profile(browser, profile_name='aaa2', desc='描述1', cfg="读写", report="读写")
		...
		add_admin(browser, admin_name="bob2", auth_database="local", temp="aaa2",
				  https="yes", telent="yes", ssh="yes", console="yes",
				  password="admin@139", confirm_password="admin@139",
				  status="enable", interface=interface_name_1, online_num="32", ip1="0.0.0.0/0")
