...
# IP-MAC Binding条目设置4000，同步到StaticARP里
# 可以正常同步并生效

def test_c139731(browser):
    try:
        ...
        # 查看静态ARP列表数量是否为4000
        count2 = get_count_number_static_arp_lzy(browser)
        print(count2)
        ...
        try:
            assert '30.1.1.1' in info1 and '30.1.1.16' in info2 and '30.1.1.20' in info3 and '30.1.1.15' in info4 and '30.1.1.16' in info5 and num1 >= 4000 and 'droped' in log1 and count2 == count1
