...
# 添加IP-MAC Binding的条目2000，验证系统运行状况
# MAC条目可以生效，系统运行正常

def test_c139729(browser):
    try:
        # 添加ip-mac-binding表达到2000条
        cli_add_ip_mac_binding_complete_lzy(devname=dev1, username="admin", password="admin@139", port=22, num1=1,
                                            num11=11, num2=1, num22=201, interface=interface_name_2,
        ...
        m = 1
        while count1 < 2000:
            cli_add_ip_mac_binding_complete_lzy(devname=dev1, username="admin", password="admin@139", port=22, num1=10 + n,
                                   num11=13 + m, num2=1, num22=201, interface=interface_name_2,
                                            mac='aa:aa:aa:aa:aa:aa')
            n = n + 3
            m = m + 3
            count1 = get_count_number_ipmac_binding_lzy(browser)
        ...
        try:
            assert '30.1.1.1' in info1 and '30.1.1.16' in info2 and '30.1.1.20' in info3 and '30.1.1.15' in info4 and '30.1.1.16' in info5 and num1 >= 2000 and 'droped' in log1
