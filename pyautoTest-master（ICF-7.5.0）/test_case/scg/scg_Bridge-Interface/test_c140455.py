...
test_id = 140455
def test_c140455(browser):
	try:
		login_web(browser, url=dev1)
		bridge_add_jyl(browser, bridge_name="br_1", block_intra_bridge_traffic="yes")
		bri_edit_jyl(browser, bridge="br_1")
		# 点击block_intra_bridge_traffic，关闭block_intra_bridge_traffic
