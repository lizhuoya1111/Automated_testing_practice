...
test_id = 140561
def test_c140561(browser):
	try:
		login_web(browser, url=dev1)
		del_all_acl_group_noadd_wxw(browser)
		add_acl_group_wxw(browser, name='acl_group_jia_1')
		add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group_jia_1', source_zone_interface=interface_name_5,
								  ...
								  dest_zone_interface=interface_name_6,
		...
		try:
			assert "ms" in ssh_info1
			assert "Unreachable" or "100% packet loss" in ssh_info2
