...
test_id = 140799
def test_c140799(browser):
	try:
		login_web(browser, url=dev1)
		start_ospf_jyl(browser)
		time.sleep(0.5)
		edit_ospf_interface_jyl(browser, ospf_interface="br_0", hello_interval="1", save="yes")
		edit_ospf_interface_jyl(browser, ospf_interface="br_0", hello_interval="65535", save="yes")
