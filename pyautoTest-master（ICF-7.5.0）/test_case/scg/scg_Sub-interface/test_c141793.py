...
def test_c141793(browser):
	try:
		...
		switch_vlan_interface_snat(browser, vlan_interface=interface_name_5+".55", snat="open")
		switch_vlan_interface_snat(browser, vlan_interface=interface_name_5 + ".55", snat="close")
