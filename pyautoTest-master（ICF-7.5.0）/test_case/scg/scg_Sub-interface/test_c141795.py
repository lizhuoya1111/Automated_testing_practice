...
def test_c141795(browser):
	try:
		...
		switch_vlan_interface_allow_ping(browser, vlan_interface=interface_name_5+".55", allow_ping="open")
		switch_vlan_interface_allow_ping(browser, vlan_interface=interface_name_5 + ".55", allow_ping="close")
