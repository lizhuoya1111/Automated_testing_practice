...
def test_c141849(browser):
	try:
		...
		add_vlan_inte_add(browser, interface_name=interface_name_4 + ".11", ipadd="20.1.1.1", mask="24")
		add_vlan_inte_add(browser, interface_name=interface_name_4 + ".11", ipadd="41.1.1.1", mask="24")
		add_vlan_inte_add(browser, interface_name=interface_name_4 + ".11", ipadd="60.1.1.1", mask="24")
		...
		shell_pc2.connect()
		result1 = shell_pc2.execute('ping 20.1.1.1 -c 8 -i 0.1')
		# print(result1)
		...
		shell_pc2.execute('ifconfig ' + server_pc_1_eth1 + ' 60.1.1.2 netmask 255.255.255.0')
		result3 = shell_pc2.execute('ping 60.1.1.1 -c 8 -i 0.1')
		# print(result3)
		shell_pc2.close()
		...
		try:
			assert "ttl" in result2 and "ttl" in result1 and "ttl" in result3
