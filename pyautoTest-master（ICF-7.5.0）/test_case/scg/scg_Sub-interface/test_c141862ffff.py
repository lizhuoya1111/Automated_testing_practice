...
def test_c141862(browser):
	try:
		...
		bri_edit_interface(browser, interface=interface_name_2, bridge_interface="br_2")
		bri_edit_interface(browser, interface=interface_name_5, bridge_interface="br_2")
		...
		shell_81.execute("native-vlan 21")
		shell_81.close()
