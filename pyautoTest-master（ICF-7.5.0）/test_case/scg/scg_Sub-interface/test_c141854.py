...
def test_c141854(browser):
	try:
		...
		add_snat(browser, name="snat1", src_inter_zone=interface_name_2 + ".21", des_inter_zone=interface_name_2 + ".20",
		         trans_local_ip="yes", )
