...
def test_c141867(browser):
	try:
		...
		shell_82.connect(hostip=dev2)
		shell_82.execute("en")
		shell_82.execute("ping 13.1.1.3")
		info1 = shell_82.output()
		# print(info1)
		shell_82.close()

		# time.sleep(800)
		add_acl_rule_complete_wxw(browser, aclgroup_name='default', source_zone_interface=interface_name_2 + ".11",
		                          dest_zone_interface=interface_name_3 + ".11",
		                          accept='no', drop='yes',
		                          )
