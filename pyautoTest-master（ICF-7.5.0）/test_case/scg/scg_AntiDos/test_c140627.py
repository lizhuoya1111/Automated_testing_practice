...
test_id = "140627"
# 添加黑/白名单 4
# 添加一条白名单，name为包含英文、数字和下划线的32个字符，description为包含中文、英文、数字、逗号、单引号、双引号的256个字符，
# 过期时间为date，输入2009-04-15，点击save


def test_c140627(browser):

	try:

		login_web(browser, url=dev1)

		add_black_or_white_list_wxw(browser, name='aaaaaaaaaaaaaaaaaaaaaaaaaaaaa_12',
									desc='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
										 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
										 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
										 'aaaaaaaaaaaaa’”中12', any='yes/no',
							   		single_ip='yes/no', sip='',
									ip='yes/no', custom='', mask='',
									address='yes/no', srange='',
									white='yes', black='yes/no', never='yes/no',
									date='yes/no', expire_date='2009-04-15', expire_time='02:00:00',
