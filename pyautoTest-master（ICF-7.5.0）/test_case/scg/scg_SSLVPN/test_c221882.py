...
def test_c221882(browser):
    try:
        ...
        # 增加Portal站点--不启用
        add_sslvpn_portal_site_complete_lzy(browser, enable='no', sitename='lzy', siteip=dev1, siteport='9091',
        ...
        sleep(0.5)
        # 打开 SCG web
        browser.get("https://10.2.2.102:9091")
        sleep(1)


        # 验证成功跳转
        info1 = browser.find_element_by_xpath('//*[@id="t"]').text
        print(info1)
