...
def test_c221872(browser):
    try:
        ...
        # 编辑--不做修改保存
        edit_sslvpn_local_admin_lzy(browser, number='1', password='admin@139', enable='yes', save='yes', cancel='no')
        ...
        # 编辑--不做修改取消
        edit_sslvpn_local_admin_lzy(browser, number='1', password='admin@139', enable='yes',
                                    save='no', cancel='yes')
