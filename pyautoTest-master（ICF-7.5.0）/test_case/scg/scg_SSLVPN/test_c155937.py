...
# 创建两条名称不同，其余配置均相同的安全站点
# 无法创建

def test_c155937(browser):
    try:
        ...
        sleep(0.5)
        # 增加安全站点
        add_sslvpn_safe_site_complete_lzy(browser, sitename='lzy1', siteip=dev1, siteport='9090', enable='yes', enable_client_authentication='no',
