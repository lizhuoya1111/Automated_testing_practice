...
def test_c143642(browser):

	try:
		login_web(browser, url=dev1)
		delete_physical_interface_ip_jyl(browser, interface=interface_name_4, ip="20.1.1.1")
		physics_interface_pppoe_set(browser, physical_interface=interface_name_4, pppoe_uesr="test", pppoe_passwd="test", idle_time="86401")
		...
		try:
			...
			assert "数值大小超过有效范围[0~86400]" in info1
			# assert True
