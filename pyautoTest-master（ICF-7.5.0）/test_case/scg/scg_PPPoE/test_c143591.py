...
def test_c143591(browser):
	...
	try:
		...
		physics_interface_pppoe_set(browser, physical_interface=interface_name_4, pppoe_uesr="test", pppoe_passwd="test", idle_time="0")
		...
		delete_physical_interface_ip_jyl(browser, interface=interface_name_4, ip="20.1.1.1")
		physics_interface_pppoe_set(browser, physical_interface=interface_name_4, pppoe_uesr="test",
		                            pppoe_passwd="test", idle_time="60")
		# time.sleep(70)
		# ppp_info = get_physics_interface_pppoe_station(browser, physical_interface=interface_name_4)
		# print(ppp_info[0])
		loginfo1 = get_log_info(browser, log_type=管理日志, num=3)
		# print(loginfo1)
		try:
			# assert True
			assert '空闲时间 [0]' in loginfo and '空闲时间 [60]' in loginfo1
