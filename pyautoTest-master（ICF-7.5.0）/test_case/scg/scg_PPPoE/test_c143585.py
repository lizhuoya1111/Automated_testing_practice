...
def test_c143585(browser):
	...
	try:
		...
		time.sleep(5)
		info_list = get_physics_interface_pppoe_station(browser, physical_interface=interface_name_4)
		# loginfo = get_log(browser, 管理日志)
		# time.sleep(10)
		loginfo = get_log_info(browser, log_type=管理日志)
		try:
			assert "停止PPPoE成功" in loginfo and "Disconnected" in info_list[0] and "0.0.0.0" in info_list[1]
