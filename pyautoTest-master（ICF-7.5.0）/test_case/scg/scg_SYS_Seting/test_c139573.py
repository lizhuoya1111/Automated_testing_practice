...
test_id = "139573"
def test_c139573(browser):
	try:
		login_web(browser, url=dev1)
		info1 = trace_route(browser, ipadd="13.1.1.3", packersize="40", count="5", ping_wait_time="2", interface=interface_name_3, timesleep=10)
		a = Shell_SSH()
		a.connect(dev1)
		a.execute("en")
		a.execute("conf t")
		...
		a.execute("exit")
		info2 = trace_route(browser, ipadd="31.1.1.3", packersize="40", count="5", ping_wait_time="2", interface=interface_name_3, timesleep=10)
