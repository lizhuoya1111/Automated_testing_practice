...
# 1. 协议选择S7，PduType选择“Unknown”，其余配置均正确，点击保存。

def test_c155748(browser):
    try:
        ...
        add_custom_rules_complete_lzy(browser, protocol_modubus='no', protocol_s7='yes', protocol='s7',
                                      ...
                                      PduType='Unknown(2)', FunctionType='OpenS7Communication(240)', action_s7='通过', save='yes', cancel='no')
        sleep(0.5)
