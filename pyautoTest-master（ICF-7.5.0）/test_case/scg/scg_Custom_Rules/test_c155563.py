...
def test_c155563(browser):
    try:
        ...
        add_custom_rules_complete_lzy(browser, protocol_modubus='yes', protocol_s7='yes/no', protocol='modbus',
                                      function='预置单寄存器', start_address='0',
                                      end_address_or_length='end_address', end_address='10',
                                      length='', start_data='0', end_data='11', action_modbus='通过',
        ...
        try:
            assert 'protocol:modbus,function:6,startaddr:0,endaddr:10,data:[0--11] 通过' in info1
