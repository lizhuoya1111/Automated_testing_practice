...
# 协议选择modbus，功能选择“读取开关输入状态”，其余配置均正确，点击保存。

def test_c155454(browser):
    try:
        ...
        add_custom_rules_complete_lzy(browser, protocol_modubus='yes', protocol_s7='yes/no', protocol='modbus',
                                      function='读取开关输入状态', start_address='0',
        ...
        while try_num < 999:
            try:
                browser.find_element_by_xpath(
                    '//*[@id="table"]/tbody/tr[' + str(try_num + 1) + ']/td[7]/a[2]/img').click()
                break
            except:
                print('没有多余条目')
                break
