...
# 1. 协议选择S7，FunctionType选择“EndUpload”，其余配置均正确，点击保存。

def test_c155761(browser):
    try:
        ...
        add_custom_rules_complete_lzy(browser, protocol_modubus='no', protocol_s7='yes', protocol='s7',
                                      ...
                                      PduType='Job(1)', FunctionType='EndUpload(31)', action_s7='通过', save='yes', cancel='no')
        sleep(0.5)
        ...
        try:
            assert 'FunctionType:31' in info1
