...
def test_c139805(browser):

	try:
		login_web(browser, url=dev1)
		add_obj_zone(browser, "abcabcabcabcabcabcabcabcabcabcab", "dabcabcabcabcabcabcabc", [interface_name_5, interface_name_6])
		add_acl_rule_complete_wxw(browser, aclgroup_name='default', source_zone_interface='Z:abcabcabcabcabcabcabcabcabcabcab',
		...
		add_snat(browser, name="snat_jia_1", desc="", src_inter_zone='Z:abcabcabcabcabcabcabcabcabcabcab', des_inter_zone=interface_name_3,
		...
		try:
			...
			assert '从区域端口 [abcabcabcabcabcabcabcabcabcabcab]' in add_acl_loginfo
			assert '配置SNAT对象成功' in add_sant_loginfo
			assert '从域/接口 [abcabcabcabcabcabcabcabcabcabcab]' in add_sant_loginfo
