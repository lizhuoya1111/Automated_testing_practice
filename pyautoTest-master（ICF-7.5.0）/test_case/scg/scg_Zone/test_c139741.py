...
def test_c139741(browser):

	try:
		login_web(browser, url=dev1)
		add_obj_zone(browser, "t23246", "d", [interface_name_3, interface_name_4, interface_name_5])
		time.sleep(2)
		info1 = browser.find_element_by_xpath('//*[@id="box"]/div[3]/ul/li[2]').text
		if info1 == "操作成功":
			zone_name = find_zone_byname(browser, "t23246")
			if zone_name == interface_name_3 + ' ' + interface_name_4 + ' ' + interface_name_5:
