...
def test_c142603(browser):
	try:
		...
		edit_snat_byname(browser, name="snat_jia_1", edit_src_inter_zone="yes", src_inter_zone=interface_name_2,
					 edit_des_inter_zone="yes", des_inter_zone=interface_name_2+".22", save="yes")
		...
		edit_snat_byname(browser, name="snat_jia_1", edit_src_inter_zone="yes", src_inter_zone="Z:zone_jia_1",
					 other_action_nomap='no', other_action_maplist="map_jia_1",
					 edit_des_inter_zone="yes", des_inter_zone="Z:zone_jia_2", save="yes")
		...
		edit_snat_byname(browser, name="snat_jia_1", edit_src_inter_zone="yes", src_inter_zone="Z:zone_jia_1",
						 other_action_nomap='no', other_action_maplist="map_jia_1",
					 edit_des_inter_zone="yes", des_inter_zone=interface_name_3, save="yes")
		...
		edit_snat_byname(browser, name="snat_jia_1", edit_src_inter_zone="yes", src_inter_zone="Z:zone_jia_1",
						 other_action_nomap='no', other_action_maplist="map_jia_1",
					 edit_des_inter_zone="yes", des_inter_zone="br_1", save="yes")
