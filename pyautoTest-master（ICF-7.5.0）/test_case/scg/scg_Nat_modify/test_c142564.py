...
def test_c142564(browser):
	try:
		...
		# 编辑IP地址范围
		edit_snat_byname(browser, name="snat_jia_1", ip_range="yes", ip_range_start="192.165.12.3",
						 ip_range_end="192.165.12.20", other_action_nomap="no",
						 other_action_maplist="no", save="yes")
		# 编辑其它动作，映射
		edit_snat_byname(browser, name="snat_jia_1", other_action_maplist="map_jia_1", save="yes")
		# 编辑转换接口地址
		edit_snat_byname(browser, name="snat_jia_1",  save="yes")
		# 编辑其它动作，不映射
		edit_snat_byname(browser, name="snat_jia_1", other_action_nomap="yes", other_action_maplist="yes", save="yes")
