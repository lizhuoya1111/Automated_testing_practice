...
test_id = 142544
def test_c142544(browser):
	try:
		login_web(browser, url=dev3)
		add_maplist_wxw(browser, name='maplist_jia_1', desc='描述', save1='yes', cancel='no',
						oriipfrom='192.168.0.1', oriipto='192.168.0.255', transipfrom='192.168.1.1', transipto='',
						one_to_one_mapping="yes", sticky='yes', portfrom='1', portto='65535', save2="yes")
