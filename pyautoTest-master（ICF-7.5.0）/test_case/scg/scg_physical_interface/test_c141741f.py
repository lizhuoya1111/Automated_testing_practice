...
def test_physical_interface_wxw(browser):
    try:
        ...
        add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group934_1', source_zone_interface=interface_name_2,
        ...
        add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group934_2', source_zone_interface=interface_name_2,
                                  source_custom='no', fromip='', fromnetmask='',
                                  source_address_object='yes', s_address_object='A:any',
                                  mac='',
                                  dest_custom='no', toip='', tonetmask='',
