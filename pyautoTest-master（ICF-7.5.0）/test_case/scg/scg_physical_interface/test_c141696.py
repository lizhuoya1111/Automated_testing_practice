...
def test_c141696(browser):
    ...
    try:
        ...
        physical_interface_switch(browser, interface=interface_name_6, status="disable")
        ...
        result1 = ssh.execute('ping 12.1.1.2 -c 10 -i 0.1')
        time.sleep(1)
        print("111111")
        print(result1)
        result2 = ssh.execute('ping 21.1.1.3 -c 10 -i 0.1')
        time.sleep(1)
        print("222222")
        print(result2)
        ssh.close()
        ...
        ssh = SSH("10.1.1.213", 'root', 'root', 22)
        ssh.connect()
        result3 = ssh.execute('ping 12.1.1.2 -c 10 -i 0.1')
        time.sleep(1)
        print("333333")
        print(result3)
        ...
        try:
            ...
            assert "100% packet loss" in result3
        ...
        physical_interface_switch(browser, interface=interface_name_6, status="enable")
