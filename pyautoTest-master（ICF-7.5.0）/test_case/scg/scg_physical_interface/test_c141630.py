...
def test_c141630(browser):
	...
	try:
		...
		add_physical_interface_static_ip_jyl(browser, interface=interface_name_3, ip='192.166.16.6', mask='255.255.255.0')
		loginfo2 = get_log(browser, 管理日志)
		delete_physical_interface_ip_jyl(browser, interface=interface_name_3, ip="192.165.12.3")
		delete_physical_interface_ip_jyl(browser, interface=interface_name_3, ip="192.166.16.6")
