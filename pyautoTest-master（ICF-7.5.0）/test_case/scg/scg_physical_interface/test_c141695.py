...
def test_physical_interface_wxw(browser):
    ...
    try:
        ...
        open_physical_interface_allowping_wxw(browser, interface=interface_name_2, allow_ping="open")
        open_physical_interface_allowping_wxw(browser, interface=interface_name_4, allow_ping="open")
        open_physical_interface_allowping_wxw(browser, interface=interface_name_6, allow_ping="open")
