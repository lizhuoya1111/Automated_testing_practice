...
def test_c141714(browser):

	try:
		login_web(browser, url=dev3)
		edit_interface_senior_jyl(browser, interface=interface_name_2, negotiation="强制", speed="10", duplex="半双工",
							  force_mtu="1500")
		a = Shell_SSH()
		a.connect(dev1)
		a.execute("en")
		...
		get_log(browser, 管理日志)
		edit_interface_senior_jyl(browser, interface=interface_name_2, negotiation="强制", speed="1000", duplex="半双工",
							  force_mtu="1500")
		a = Shell_SSH()
		a.connect(dev1)
		a.execute("en")
