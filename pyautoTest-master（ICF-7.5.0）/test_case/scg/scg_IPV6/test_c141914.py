...
test_id = 141914
def test_c141914(browser):
	try:
		login_web(browser, url=dev3)
		edit_neighbor_discovery_jyl(browser, physical_interface=interface_name_3, retransmission_time="2000",
									base_reachable_time="50000 ", duolicate_add_retry_count="10", save="yes")
