...
test_id = 141911
def test_c141911(browser):
	try:
		login_web(browser, url=dev3)
		edit_neighbor_discovery_jyl(browser, physical_interface=interface_name_3, retransmission_time="1000",
									base_reachable_time="30000", duolicate_add_retry_count="0", save="yes")
		loginfo1 = get_log(browser, 管理日志)
		edit_neighbor_discovery_jyl(browser, physical_interface=interface_name_3, retransmission_time="1000",
									base_reachable_time="30000 ", duolicate_add_retry_count="600", save="yes")
