...
test_id = 142161
# 配置Radius服务器back2地址，如10.0.0.3

def test_c142161(browser):
    try:
        ...
        add_RADIUS_aut_server_lzy(browser, server_name="lzy", description="abcdef", server_address="10.0.0.1", backup_host_1="10.0.0.2",
                                  backup_host_2="10.0.0.3", port="1812", retry="3", timeout="2", password="", PAP="yes/no",
                                  CHAP="yes",
        ...
        try:
            assert "10.0.0.3" in info1 and "成功添加 aaa server" in log1
