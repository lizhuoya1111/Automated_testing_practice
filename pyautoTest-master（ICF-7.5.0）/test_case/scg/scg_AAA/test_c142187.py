...
test_id = 142187
# 配置baseDN:dc=pip,dc=cn

def test_c142187(browser):
    try:
        ...
        add_LDAP_aut_server_lzy(browser, server_name="lzy", description="abcdef", server_address="10.0.0.1", backup_host_1="",
                                backup_host_2="", port="389", LDAP="yes/no", basedn="dc=pip", admin="", password="",
        ...
        add_LDAP_aut_server_lzy(browser, server_name="lzy1", description="abcdef", server_address="10.0.0.1",
                                backup_host_1="",
                                backup_host_2="", port="389", LDAP="yes/no", basedn="dc=cn", admin="", password="",
                                confirm_password="", timeout="2", save="yes", cancel="yes/no")
        ...
        try:
            assert "dc=pip" in info1 and "dc=cn" in info1 and "server" in log1
