...
def test_c142451(browser):
    try:
        login_web(browser, url=dev5)
        # 服务器的ip地址输入A.2.3.155、#.$.4.5 、1.1.1.256
        info1 = return_alert_add_AD_aut_server_lzy(browser, server_name="lzy", description="", server_address="A.1.1.1",
                                           backup_host_1="",
                                           backup_host_2="", domain="", NTLM="yes", NTLM2="yes/no", LDAP="yes/no",
                                           save="yes", cancel="yes/no")
        print(info1)
        info11 = return_alert_add_AD_aut_server_lzy(browser, server_name="lzy", description="", server_address="#.$.1.1",
                                                   backup_host_1="",
                                                   backup_host_2="", domain="", NTLM="yes", NTLM2="yes/no",
                                                   LDAP="yes/no",
                                                   save="yes", cancel="yes/no")
        print(info11)
        info111 = return_alert_add_AD_aut_server_lzy(browser, server_name="lzy", description="", server_address="1.1.1.256",
                                                   backup_host_1="",
                                                   backup_host_2="", domain="", NTLM="yes", NTLM2="yes/no",
                                                   LDAP="yes/no",
                                                   save="yes", cancel="yes/no")
        ...
        info3 = return_alert_add_AD_aut_server_lzy(browser, server_name="lzy",
                                                   description="",
                                                   server_address="255.255.255.258",
                                                   backup_host_1="",
                                                   backup_host_2="", domain="", NTLM="yes", NTLM2="yes/no",
                                                   LDAP="yes/no",
                                                   save="yes", cancel="yes/no")
