...
test_id = 142215
# 配置http认证端口（1-65535），看能否下发
# 全局设置
def test_c142215(browser):
    try:
        login_web(browser, url=dev5)
        # 全局设置
        add_globel_setting_lzy(browser, frozen="yes", frozen_time="30", retry="1", interval_time="30",
                               phone_interval="1200", idle_time="15", sms_center="111222333", HTTP_port="801",
        ...
        try:
            assert "aaa global setting" in log1 and "http_port=80 is_frozen=1" in log2 and "http_port=801" in log1
