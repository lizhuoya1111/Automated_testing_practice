...
def test_c139646(browser):

	try:
		login_web(browser, url=dev1)
		add_static_arp_jyl(browser, ip="12.1.1.2", interface=interface_name_2, mac_add="auto_mac",
						   host_name="manual_host", host="主机82")
		edit_static_arp_jyl(browser, edit_arp_ip="12.1.1.2", ip="12.1.1.2", interface=interface_name_2,
							mac_add="manual_mac", mac="00:16:31:ee:03:96", host_name="manual_host",
							host="我是主机82")
