...
def test_physical_interface_wxw(browser):
    ...
    add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group933_1', source_zone_interface='ge0/4',
    ...
    add_acl_rule_complete_wxw(browser, aclgroup_name='acl_group933_2', source_zone_interface='ge0/4',
                     source_custom='no', fromip='', fromnetmask='',
                     source_address_object='yes', s_address_object='A:any',
                     mac='',
                     dest_custom='no', toip='', tonetmask='',
...
if __name__ == '__main__':
    pytest.main(["-v", "-s", "test_c37933.py"])