...
def test_main(browser):
	try:
		...
		time.sleep(2)
		physical_interface_update_dhcp_jyl(browser, physical_interface="ge0/2", update_system_dns="open", update_default_gateway="open")
		time.sleep(3)
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_update_dhcp_jyl(browser, vlan_interface="ge0/2.22", update_system_dns="open", update_default_gateway="open")
		time.sleep(3)
		get_log_info(browser, 管理日志)
		time.sleep(2)
