...
def test_main(browser):
	try:
		...
		dhcp_server_add_jyl(browser, interface="ge0/2", dhcp_type="dhcp_server", dhcp_gw="13.1.1.254",
		...
		time.sleep(2)
		physics_interface_from_dhcp_obtain_ip_jyl(browser, physical_interface="ge0/3", work_mode="dhcp", snat="open",)
		time.sleep(2)
		num = Shell_SSH()
		num.connect('10.1.1.202', 'root', 'root')
		num.execute('ping 13.1.1.3 -c 3 -i 0.2')
		time.sleep(10)
		result1 = num.output()
		print(result1)

		time.sleep(2)
		physical_interface_obtain_ip_dhcp_status_jyl(browser, physical_interface="ge0/3", work_mode="dhcp", dhcp_status2="stop",)
		time.sleep(3)
		a = Shell_SSH()
		a.connect("10.2.2.81")
		a.execute("en")
