...
def test_main(browser):
	try:
		...
		time.sleep(2)
		physical_intertface_obtain_ip_address_from_dhcp1_jyl(browser, physical_interface="ge0/2")
		time.sleep(2)
		# 获取信息
		...
		a.execute("en")
		a.execute("conf t")
		a.execute("interface vlan ge0/2.22")
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_obtain_ip_fromdhcp1_jyl(browser, vlan_interface="ge0/2.22")
		time.sleep(2)
