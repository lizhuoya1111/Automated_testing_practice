...
def test_main(browser):
	try:
		...
		time.sleep(2)
		physics_interface_from_dhcp_obtain_ip_jyl(browser, physical_interface="ge0/2", work_mode="dhcp",
		...
		a.execute("exit")
		time.sleep(5)
		vlan_interface_from_dhcp_obtain_ip_jyl(browser, vlan_interface="ge0/2.22", work_mode="dhcp",
		                                       dhcp_status1="release_recapture", dhcp_status2="click")
