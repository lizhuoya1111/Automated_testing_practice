...
def configuer(browser):
	...
	add_admin(browser, admin_name="bob", temp="aaa", https="no", telent="yes", ssh="no", console="on", online_num="32",interface="ge0/4", ip1="0.0.0.0/0")
	"""
	# 点击编辑按钮
...
if __name__ == '__main__':
	pytest.main(["-v", "-s", "test_c21542.py"])