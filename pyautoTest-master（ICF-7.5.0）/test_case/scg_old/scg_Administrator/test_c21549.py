...
def configuer(browser):
	sys_set_jyl(browser, ssh_port="22", ssh_timeout="600", https_port="443", https_timeout="600", telent_port="23", telent_timeout="600", console_timeout="600", frozen_time="600", expire_time="600", retry="3")


if __name__ == '__main__':
	pytest.main(["-v", "-s", "test_c21549.py"])
