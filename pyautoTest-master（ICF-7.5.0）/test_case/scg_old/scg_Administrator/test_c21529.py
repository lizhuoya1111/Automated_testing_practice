...
def configuer(browser):
    add_admin_profile(browser, profile_name='ana', desc='tinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatinatina\
    限123456780123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890', cfg = "只读", report = "无权限")


if __name__ == '__main__':
    pytest.main(["-v", "-s", "test_c21529.py"])