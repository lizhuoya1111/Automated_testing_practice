...
def test_admin_user_add(browser):
	...
	time.sleep(2)
	for x in range(1, 32):
		add_admin(browser, admin_name="bob"+str(x) , auth_database="local", temp="aaa", https="yes" , telent="no", ssh="yes", console="yes",status="enable",interface="ge0/5",online_num="3", ip1="0.0.0.0/0")
	# 获取web页面最大管理员数目
...
if __name__ == '__main__':
	pytest.main(["-v", "-s", "test_c21540.py"])
