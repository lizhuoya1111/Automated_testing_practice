...
test_id = 40394
# 添加一条schedule, recurring为1:00 to 2:00,查看log
...
def test_obj_wxw(browser):
    ...
    try:
        ...
        add_obj_schdule_wxw(browser, name='schdule_394', desc='描述', recurring='yes', fromtime='01:00', totime='02:00')
        ...
        try:
            assert "配置日程表对象成功，添加内部对象 [schdule_394]" in loginfo
...
if __name__ == '__main__':
    pytest.main(["-v", "-s", "test_c40394.py"])