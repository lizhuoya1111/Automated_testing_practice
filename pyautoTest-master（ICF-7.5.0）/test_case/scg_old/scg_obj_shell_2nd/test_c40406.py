...
def test_obj_wxw(browser):
    ...
    try:
        ...
        add_obj_schdule_wxw(browser, name='schdule_406', desc='描述', recurring='yes', fromtime='01:00', totime='02:00')

        del_obj_schdule_wxw(browser, name='schdule_40 6')
        time.sleep(2)
        ...
        # print(loginfo)
        try:
            assert "配置日程表对象成功，删除内部对象 [schdule_406]" in loginfo
...
if __name__ == '__main__':
    pytest.main(["-v", "-s", "test_c40406.py"])