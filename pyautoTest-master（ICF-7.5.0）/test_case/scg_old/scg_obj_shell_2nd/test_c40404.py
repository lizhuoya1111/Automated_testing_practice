...
def test_obj_wxw(browser):
    ...
    try:
        ...
        for n in range(1, 6):
            add_obj_schdule_wxw(browser, name='schdule_404_'+str(n), desc='描述', recurring='yes', fromtime='01:00', totime='02:00')
        del_all_schdule_wxw(browser)
        time.sleep(2)
...
if __name__ == '__main__':
    pytest.main(["-v", "-s", "test_c40404.py"])