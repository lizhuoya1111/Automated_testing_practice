...
def configuer(browser):
    dhcp_server_add_jyl(browser, interface="ge0/3", dhcp_type="dhcp_server", dhcp_gw="13.1.1.254", dhcp_sm="24")
    time.sleep(2)
    # 点击启用
    browser.find_element_by_xpath('//*[@id="net_dhcp_setting"]').click()
    # 点击返回
    browser.find_element_by_xpath('//*[@id="link_but"]').click()
    dhcp_server_edit_or_delete_jyl(browser, fuction="edit", dhcp_type="rely", dhcp_rely_server1="117.117.117.117")
    time.sleep(2)
    # 点击启用
    browser.find_element_by_xpath('//*[@id="net_dhcp_setting"]').click()
    # 点击返回
    browser.find_element_by_xpath('//*[@id="link_but"]').click()
    dhcp_server_edit_or_delete_jyl(browser, fuction="edit", dhcp_type="none")
    time.sleep(2)
