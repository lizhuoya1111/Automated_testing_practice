...
def test_main(browser):
	try:
		...
		# print(webinfo1)
		time.sleep(1)
		webinfo11 = browser.find_element_by_xpath('//*[@id="conftr_0"]/td[2]/span[2]').text
		# print(webinfo11)
		login_web(browser, url=dev1)
		...
		# print(webinfo2)
		time.sleep(1)
		webinfo22 = browser.find_element_by_xpath('//*[@id="table"]/tbody/tr[2]/td[5]').text.rstrip().upper()
		# print(webinfo22)
		login_web(browser, url=dev3)
		time.sleep(1)
