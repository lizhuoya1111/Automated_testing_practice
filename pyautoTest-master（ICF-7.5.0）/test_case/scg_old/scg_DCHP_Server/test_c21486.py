...
def test_main(browser):
	try:
		...
		if num == "0":
			...
			# 输入dhcp网关
			browser.find_element_by_xpath('//*[@id="gateway"]').send_keys("13.1.1.4")
			# 输入dhcp子网掩码
			browser.find_element_by_xpath('//*[@id="netmask"]').send_keys("24")
			# 输入dhcp ip地址范围1
			browser.find_element_by_xpath('//*[@id="ipfrom1"]').send_keys("13.1.1.6")
			browser.find_element_by_xpath('//*[@id="ipto1"]').send_keys("13.1.1.255")
			# 点击保存
