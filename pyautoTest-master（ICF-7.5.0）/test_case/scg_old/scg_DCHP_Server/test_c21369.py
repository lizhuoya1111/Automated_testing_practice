...
def configuer(browser):
	dhcp_server_add_jyl(browser, interface="ge0/3", dhcp_type="dhcp_server", dhcp_gw="13.1.1.254", dhcp_sm="24",
						ip_range1_1="13.1.1.4", ip_range1_2="13.1.1.10", ip_range2_1="13.1.1.11", ip_range2_2="13.1.1.20",
						senior="yes", static_ip_add1="13.1.1.13", static_mac_add1="00:16:31:f8:5d:7b")
