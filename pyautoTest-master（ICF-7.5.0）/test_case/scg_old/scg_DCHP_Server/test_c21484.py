...
def test_main(browser):
	try:
		...
		if num == "0":
			...
			browser.find_element_by_xpath('//*[@id="ipto1"]').send_keys("13.1.1.20")
			# 点击高级
			browser.find_element_by_xpath('//*[@id="is_dhcp_adv"]').click()
			# 输入静态ip地址
			browser.find_element_by_xpath('//*[@id="ip0"]').send_keys("13.1.1.254")
			# 输入静态mac地址
			...
			browser.find_element_by_xpath('//*[@id="work_mode_0"]').click()
			# 输入dhcp网关
			browser.find_element_by_xpath('//*[@id="gateway"]').send_keys("13.1.1254")
			# 输入dhcp子网掩码
			browser.find_element_by_xpath('//*[@id="netmask"]').send_keys("24")
			# 输入dhcp ip地址范围1
			browser.find_element_by_xpath('//*[@id="ipfrom1"]').send_keys("13.1.1.4")
