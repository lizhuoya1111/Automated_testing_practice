...
def test_main(browser):
	try:
		...
		# 定位到内容frame
		browser.switch_to.frame("content")
		dhcp_server_edit_or_delete_jyl(browser, fuction="edit", dhcp_type="server", lease_time_day="100")
		time.sleep(2)
		# 切换到默认frame
		browser.switch_to.default_content()
		# 切换到左侧frame
...
def configuer(browser):
	dhcp_server_add_jyl(browser, interface=interface_name_3, dhcp_type="dhcp_server", dhcp_gw="13.1.1.254", dhcp_sm="24",lease_time_day="7")
	time.sleep(2)
