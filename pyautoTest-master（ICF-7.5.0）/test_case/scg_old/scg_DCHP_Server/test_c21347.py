...
def configuer(browser):
	dhcp_server_add_jyl(browser, interface="ge0/3", dhcp_type="dhcp_server", dhcp_gw="13.1.1.254", dhcp_sm="24", lease_time_day="0", lease_time_hours="0", lease_time_second="300")
	time.sleep(2)
