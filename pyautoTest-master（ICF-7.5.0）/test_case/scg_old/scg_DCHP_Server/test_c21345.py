		...
		if num == "0":
			...
			while i < int(num):
				...
				if enable == True:
					...
					i += 1
			configuer(browser)
		webinfo1 = browser.find_element_by_xpath('//*[@id="table"]/tbody/tr[2]/td[5]/span').text
		# print(webinfo1)
		time.sleep(1)
...
def configuer(browser):
	dhcp_server_add_jyl(browser, interface="ge0/3", dhcp_type="dhcp_server", dhcp_gw="14.1.1.254", dhcp_sm="24")
	time.sleep(2)
