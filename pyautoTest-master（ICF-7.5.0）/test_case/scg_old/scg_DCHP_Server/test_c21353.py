...
def configuer(browser):
	dhcp_server_add_jyl(browser, interface="ge0/3", dhcp_type="dhcp_server", dhcp_gw="13.1.1.254", dhcp_sm="24", wins_server1="115.115.115.115", senior="yes", wins_server2="117.117.117.117")
