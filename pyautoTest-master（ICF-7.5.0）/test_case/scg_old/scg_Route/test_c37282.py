...
def test_route_wxw(browser):
	...
	try:
		...
		add_static_route_single_wxw(browser, ip='20.1.1.0', mask='24', out_device='ge0/2', gateway='13.1.1.'
																								   '1',
									enable='yes')
		...
		edit_static_route_single_wxw(browser, destination='20.1.1.0/255.255.255.0', ip='21.1.1.0', mask='24',
									 out_device='ge0/2', gateway='13.1.1.1', enable='yes')
...
if __name__ == '__main__':
	pytest.main(["-v", "-s", "test_c37282.py"])