...
def test_route_wxw(browser):
	...
	try:
		...
		for n in range(1, 5):
			...
			add_multi_gateway_group_wxw(browser, name='mgg_191_'+str(n), group="1(GROUP_1)", modify='no', alias='',
									    device='ge0/3', gateway='24.1.1.1'+str(n), ping_server='34.1.1.4', ping='yes',
									    arp='no', time_switch='7', ub="100000", db="100000")

		add_policy_route_multi_wxw(browser, in_device='ge0/3', src_ip='45.1.1.0', src_mask='24',
		...
		source = get_policy_route_source_wxw(browser, destination='20.1.1.0/255.255.255.0')
		# print(source)
		...
		try:
			...
			assert source == "45.1.1.0/255.255.255.0"
