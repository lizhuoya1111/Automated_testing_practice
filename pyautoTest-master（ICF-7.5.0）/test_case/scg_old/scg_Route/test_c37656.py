...
test_id = 37656
# ADRT_MODIFY_POLICY_ROUTE_SUCCESS
...
def test_route_wxw(browser):
	...
	try:
		...
		edit_policy_route_single_wxw(browser, destination='12.1.1.0/255.255.255.0', in_device='ge0/2', src_ip='12.1.1.0',
									 src_mask='24',
									 dst_ip='24.1.1.0', dst_mask='24', service='no', serv='any',
									 service_grp='no', serv_grp='H323',
									 out_device='ge0/3', gateway='34.1.1.4', enable='yes',
									 disnable='no', desc='maioshu')

		loginfo1 = get_log_info(browser, 管理日志)
		# print(loginfo1)

		del_policy_route_singele_wxw(browser, destination='24.1.1.0/255.255.255.0')


		try:
			assert "修改策略路由对象成功"in loginfo1
